...
<div class="pricing-plan-wrapper">
    <div id="subscribeDataModalWrapperOuter" class="subscribe-data-modal-wrapper-outer">
        <div class="subscribe-data-modal-wrapper-inside">
            <h2 class="plan-label">Start Today</h2>
            <div class="row">
                <div class="row-inside first-modal">
                    ...
                    <div class="col s12 m12 l12 subscription_plan_block_outer">
                        <div class="subscription_plan_block paid_block">
                            <div class="subscription_pricing_block">
                                <div class="row">
                                    <div class="col s12">
                                        <div class="yearly_billing_message" style="display: none;">After your free trial month, you will be charged</div>
                ...
                <div class="second-modal" style="display: none;">
                    <div class="backArrow">
                    ...
                    <div class="row-inside row">
                        <div class="col s12 m6 l6">
                            <div class="selected_plan_content"></div>
                        </div>
                        <div class="col s12 m6 l6">
