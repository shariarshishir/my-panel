<div id="product-add-modal-block" class="modal fullscreen-modal wholesaler_add_product_modal profile_form_modal profile_product_upload_modal">
                    ...
                    <div class="row" style="padding: 15px 0 30px;">
                        ...
                        <div class="col s12 m6 l4 xl3 input-field">
                            <div class="product-upload-block">
                                ...
                                <div id="lineitems_video" class="lineitems_video">
                                        ...
                                        <table class="color-size-table-block add-color-sizes">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td data-title="5XXL"><input type="text" value="" class="form-control count-color-size negitive-or-text-not-allowed" name="color_size[five_xxl][]" /></td>
                                                    <td data-title="6XXL"><input type="text" value="" class="form-control count-color-size negitive-or-text-not-allowed" name="color_size[six_xxl][]" /></td>
                    ...
                    <div class="row">
                        <div class="col s12 input-field">
                            ...
                            <div class="moqQuantity">
                                <input placeholder="Minimum Order Quantity" id="moq" type="number" class="form-control @error('moq') is-invalid @enderror" name="moq" value="{{ old('moq') }}"  autocomplete="moq" autofocus>
