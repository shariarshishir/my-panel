                ...
                <div class="form-group factory-tour-photo factory_images_box">
                    ...
                    <div class="row factory_images_box_wrap">
                        ...
                        <div class="uploaded-factory-image-block">
                            ...
                            <img id="previous-uploaded-factory-image" src="{{Storage::disk('s3')->url('public/'.$image->factory_image)}}" alt="preview image" style="max-height: 80px;min-height:80px">
                        </div>
                        @endforeach
                        @endif
                        @endif
                        ...
                        @if(count($companyFactoryTour->companyFactoryTourLargeImages)>0 )
                            @foreach($companyFactoryTour->companyFactoryTourLargeImages as $image)
                                <div class="uploaded-factory-large-image-block">
                                    ...
                                    <img id="previous-uploaded-factory-image" src="{{Storage::disk('s3')->url('public/'.$image->factory_large_image)}}" alt="preview image" style="max-height: 80px;min-height:80px">
                                </div>
                            @endforeach
                        @endif
                        @endif
