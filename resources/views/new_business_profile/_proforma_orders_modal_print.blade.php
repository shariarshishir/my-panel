    <div class="proforma_invoice_pdf_design_table_wrap">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="addressBar" style="padding:0; margin: 0;">
                                <h3 style="padding: 0; margin: 0; font-size: 16px; line-height: normal; color: #000; font-weight: 600;"><span style="padding: 0; margin: 0;">Merchant Bay</span></h3>
                                <p style="margin: 0; padding:0; line-height: normal;">Meem Tower, Floor: 8, House: 18, Road: 12, Sector: 6, Uttara, Dhaka.</p>
                            </div>
                        </td>
                        <td>
                            <div class="conactInfo" style="padding: 10px 0 0" >
                                <p style="padding: 0; margin: 0; line-height: normal;">Tel: <b>01302-699567</b></p>
                                <p style="padding: 0; margin: 0; line-height: normal;">Email: <b>success@merchantbay.com</b></p>
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <div class="proformaInvoiceTiytle">
            <h3 style="text-align: center; font-weight: 600; text-transform: uppercase; margin: 0px; font-size: 16px; padding: 0; line-height: normal;">Proforma Invoice</h3>
        </div>
        <table class="table table-bordered proforma_beneficiary_table" style="border: 1px solid #ddd; margin-bottom: 15px;">
                ...
                <tr>
                    <td style="padding: 10px;">
                        <div class="beneficiarybox">
                            <h6 style="font-size: 14px; line-height: normal; margin: 0 0 5px;">Buyer Detail :</h6>
                            <div class="beneficiaryInfo">
                                <p style="margin: 0; padding:0; line-height: 16px;"><b>{{$proforma->businessProfile->business_name ?? ""}}</b></p>
                                <p style="margin: 0; padding:0; line-height: 16px;">{{$proforma->businessProfile->location ?? ""}}</p>
                                <p style="margin: 0; padding:0; line-height: 16px;"> Date: <span>{{ $proforma->proforma_date }}</span></p>
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <table class="table table-bordered proforma_item_info_table" style="text-align: center; margin: 0 0 15px; border: 1px solid #ddd; overflow: inherit;">
                        ...
                        <tbody id="lineitems" class="">
                            @foreach($proforma->performa_items as  $key => $proFormaItem)
                                <tr>
                                    <td style="border: 1px solid #ddd; padding: 5px 10px;" data-title="Sl. No.">{{$key+1 }}</td>
                                    <td style="border: 1px solid #ddd; padding: 5px 10px;" data-title="Item / Description">
                                        <span style="padding: 0; margin: 0;">{{ $proFormaItem->item_title }}</span>
                                    </td>
                                    <td style="border: 1px solid #ddd; padding: 5px 10px;" data-title="Quantity">
                                        <span style="padding: 0; margin: 0;">{{ $proFormaItem->unit }}</span>
                                    </td>
                                    <td style="border: 1px solid #ddd; padding: 5px 10px;" data-title="Unit Price">
                                        <span style="padding: 0; margin: 0;">{{ $proFormaItem->unit_price }}</span>
                                    </td>
                                    <td style="border: 1px solid #ddd; padding: 5px 10px;" data-title="Sub Total">
                                        <span style="padding: 0; margin: 0;">{{ $proFormaItem->total_price }}</span>
                                    </td>
                                    <td style="border: 1px solid #ddd; padding: 5px 10px;" data-title="Total Price">
                                        <span style="padding: 0; margin: 0;">{{ $proFormaItem->tax_total_price }}</span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tr>
                            <td colspan="5" class="right-align sub_total_title" style="border: 1px solid #ddd; padding: 5px 10px;"><b style="padding: 0; margin: 0;">Sub Total: </b></td>
                        ...
                        <tr>
                            <td colspan="5" class="right-align sub_total_title" style="border: 1px solid #ddd; padding: 5px 10px;">Commission:</td>
                            <td data-title="Commission:" colspan="2">{{ number_format((float)$proforma->proforma_commission, 2, '.', '') }} %</td>
                        </tr>
                        @endif
                        @if($proforma->proforma_vat)
                        <tr>
                            <td colspan="5" class="right-align sub_total_title" style="border: 1px solid #ddd; padding: 5px 10px;">Vat:</td>
                            <td data-title="Vat:" colspan="2">{{ number_format((float)$proforma->proforma_vat, 2, '.', '') }} %</td>
                        </tr>
                        @endif
                        @if($proforma->proforma_tax)
                        <tr>
                            <td colspan="5" class="right-align sub_total_title" style="border: 1px solid #ddd; padding: 5px 10px;">Tax:</td>
                            <td data-title="Tax:" colspan="2">{{ number_format((float)$proforma->proforma_tax, 2, '.', '') }} %</td>
                        </tr>
                        @endif
                        <tr>
                            <td colspan="5" class="right-align grand_total_title" style="border: 1px solid #ddd; padding: 5px 10px;"><b style="padding: 0; margin: 0;">Grand Total: </b></td>
                        ...
                        <tr>
                            <td colspan="5" class="right-align grand_total_title" style="border: 1px solid #ddd; padding: 5px 10px;"><b style="padding: 0; margin: 0;">{{$assistance->merchantAssistance->name}}: </b></td>
                        ...
                        <tr>
                            <td colspan="5" class="right-align grand_total_title" style="border: 1px solid #ddd; padding: 5px 10px;"><b style="padding: 0; margin: 0;">Your total order amount with merchant assistant : </b></td>
            ...
            <div class="no_more_tables">
                <table class="table table-bordered proforma_forward_table" style="text-align: left; margin-bottom: 15px; border: 1px solid #ddd;">
                    ...
                    <tbody>
                        <tr>
                            <td data-title="forwarder Name" style="border: 1px solid #ddd; padding: 5px 10px;">
                                <span> {{ $proforma->forwarder_name }} </span>
                            </td>
                            <td data-title="forwarder Address" style="border: 1px solid #ddd; padding: 5px 10px;">
                                <span> {{ $proforma->forwarder_address }} </span>
                            </td>
                            <td data-title="Payable Party" style="border: 1px solid #ddd; padding: 5px 10px;">
                ...
                <table class="table table-bordered proforma_shipment_table" style="text-align: center; border: 1px solid #ddd; margin-bottom: 15px;">
                    ...
                    <tbody>
                        @foreach($proforma->proFormaShippingDetails as $shippingDetails)
                            <tr>
                                <td data-title="Shipment Term" style="border: 1px solid #ddd; padding: 5px 10px;">
                                    <span>{{ $shippingDetails->shippingMethod->name }}</span>
                                </td>
                                <td data-title="Place of Shipment" style="border: 1px solid #ddd; padding: 5px 10px;">Place of Shipment</td>
                                <td data-title="Mode of Transport" style="border: 1px solid #ddd; padding: 5px 10px;">
                                    <span>{{ $shippingDetails->shipmentType->name }}</span>
                                </td>
                                <td data-title="ace of Destination" style="border: 1px solid #ddd; padding: 5px 10px;">
                                    <span>
                                ...
                                <td data-title="UOM" style="border: 1px solid #ddd; padding: 5px 10px;">
                                    <span>{{ $shippingDetails->uom->name }} </span>
                                </td>
                                <td data-title="Per UOM Price ($)" style="border: 1px solid #ddd; padding: 5px 10px;">
                                    <span>{{ $shippingDetails->shipping_details_per_uom_price }}</span>
                                </td>
                                <td data-title="QTY" style="border: 1px solid #ddd; padding: 5px 10px;">
                                    <span>{{ $shippingDetails->shipping_details_qty }}</span>
                                </td>
                                <td data-title="Total ($)" style="border: 1px solid #ddd; padding: 5px 10px;">
                    ...
                    <tbody style="border: none">
                        <tr style="border: none">
                            <td data-title="Payment Info:" style="border: none;">
                                <div class="conactInfo" style="padding: 0 10px">
                                    <p style="padding: 0; margin: 0 0 3px 0; line-height: 16px;">Payment Within: <b><span> {{$proforma->payment_within ?? ""}} </span></b></p>
                                    <p style="padding: 0; margin: 0; line-height: 16px;">Payment Term: <b><span> {{$proforma->paymentTerm->name ?? ""}} </span></b></p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <table class="table proforma_terms_onditions_table" style="border: 1px solid #ddd; margin-bottom: 15px">
                ...
                <tbody style="border: none">
                    <tr style="border: none">
                        <td style="border: none; padding: 5px; 10px 0">
                            <div class="terms_conditions_list buyerdata_info_admin" style="padding: 0; margin: 0">
                                <ul class="list-group terms-lists" style="padding: 10px 5px 0; margin: 0;">
                                    @foreach($proforma->supplierCheckedProFormaTermAndConditions as $supplierCheckedProFormaTermAndCondition)
                                    <li class="list-group-item" style="padding: 5px 0; margin: 0; border: none; line-height: 16px;">
                                ...
                                <ul class="list-group terms-lists" style="padding: 10px 5px 0; margin: 0;">
                                    ...
                                    <li class="list-group-item" style="padding: 0; margin: 0; border: none; line-height: 16px;">
                                        <div class="input-group" style="margin: 0; padding:0">
                                            <label class="terms-label" style="font-weight: 400;">
                    ...
                    <tr style="border: none">
                        <td style="border: none">
                            <div class="conactInfo" style="padding: 5px;">
                                <p style="padding: 0; margin: 0; line-height: 16px;"><b><span> {{$proforma->proFormaAdvisingBank->bank_name ?? ""}} </span></b></p>
                                <p style="padding: 0; margin: 0; line-height: 16px;"><span>{{ $proforma->proFormaAdvisingBank->branch_name ?? "" }}</span></p>
                                <p style="padding: 0; margin: 0; line-height: 16px;"><span> {{ $proforma->proFormaAdvisingBank->bank_address ?? "" }} </span></p>
                                <p style="padding: 0; margin: 0; line-height: 16px;">Swift code: <b> <span>{{ $proforma->proFormaAdvisingBank->swift_code ?? "" }}</span></b> </p>
                            </div>
                        </td>
                    </tr>
                </tbody>
