...
<script>
    ...
    $('.createRfqForm').on('submit',function(e){
        ...
        $(document).ready(function(){
            ...
            $(document).on("change", ".supplier_short_list_trigger_from_frontend", function(){
                ...
                {
                    swal({
                        title: "Are you sure? You want to add this profile in short list",
                        text: "",
                        type: "info",
                        showCancelButton: !0,
                ...
                {
                    swal({
                        title: "Are you sure? You want to remove this profile from short list",
                        text: "",
                        type: "info",
                        showCancelButton: !0,
                        confirmButtonText: "Yes",
            ...
            $(document).on("change", ".supplier_selected_trigger_from_frontend", function(){
                var businessProfileId = $(this).attr("data-businessprofileid");
                var rfqId = $(this).attr("data-rfqid");
                ...
                {
                    swal({
                        title: "Are you sure? You want to select this profile.",
                        text: "",
                        type: "info",
                        showCancelButton: !0,
                        confirmButtonText: "Yes",
                ...
                {
                    swal({
                        title: "Are you sure? You want to unselect this profile.",
                        text: "",
                        type: "info",
                        showCancelButton: !0,
                        confirmButtonText: "Yes",
