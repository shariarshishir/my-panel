                        ...
                        <div class="col s4 l4 help_menu" itemscope>
                            ...
                            <div class="col s4 l3 info_menu" itemscope>
                                <ul itemscope itemtype="https://schema.org/ListItem">
                                    ...
                                    <li itemprop="itemListElement"><a itemprop="Site Map" href="{{route('show.site.map')}}">Site Map</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<div id="login-register-modal" class="modal modal-fixed-footer" tabindex="0">
                ...
                <form method="POST" action="#">
                    ...
                    <div class="row">
                        <div class="input-field col s12 password-block-wrap">
                            ...
                            @enderror
                            <span id="show-password"><i class="material-icons">visibility</i></span>
                            <span id="hide-password" style="display: none;"><i class="material-icons">visibility_off</i></span>
                        </div>
                    </div>
    ...
    <div class="modal-footer">
        <span class="modal-action modal-close waves-effect waves-green btn-flat "><i class="material-icons green-text text-darken-1">close</i></span>
    </div>
</div>
...
<script>
  ...
  <script>
    ...
    html += '<td data-title="5XXL"><input type="text" value="" class="form-control negitive-or-text-not-allowed" name="color_size[five_xxl][]" /></td>';
    html += '<td data-title="6XXL"><input type="text" value="" class="form-control negitive-or-text-not-allowed" name="color_size[six_xxl][]" /></td>';
