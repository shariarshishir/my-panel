...
@php
    ...
    {   // first param from mb and second from shop
        ...
        $selected_product_tags = $product->product_tag ?? $product->product_tag;
    }
    else
    {
        $product_title = "";
                                        ...
                                        <div class="col s12 input-field">
                                            ...
                                            <select class="select2" id="category_id" name="category[]" multiple required >
                                                ...
                                                @foreach($product_tags as $product_tag)
                                                    <option value="{{ $product_tag->id }}" {{ in_array($product_tag->name, $selected_product_tags) ? "selected":"" }}>{{ $product_tag->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col s12 input-field">
                                        ...
                                        <div class="col s12 xl6">
                                            <div class="input-field">
                                                ...
                                                @if($product->flag == "mb")
                                                    ...
                                                    <div class="rfqPrice">
                                                        <span>USD</span>
                                                        <input type="text" class="price_input" id="target_price" name="unit_price" value="{{ $product->price_per_unit }}" required onchange="allowTwoDecimal()" />
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            $.each(images, function(index, value){
                                let obj = {'product_image' :  "https://s3.ap-southeast-1.amazonaws.com/service.products/public/"+(value.product_image || value.image) , 'created_at' : value.created_at, 'updated_at' : value.updated_at };
