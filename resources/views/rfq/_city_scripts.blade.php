...
var countryListArray = @json($countrysList);
...
// {
//     var regionList = "";
//     regionList += '<option value="" selected="selected">SELECT REGION</option>';
//     for (region in countries) {
//         regionList += '<option value="'+region+'">'+region+'</option>';
//     }

//     document.getElementById("region-list").innerHTML = regionList;
// }
// setRegions(this);
...
{
    var countryList = "";
    countryList += '<option value="" selected="selected">Select Country</option>';
    countryListArray.map(i=>{
        countryList += '<option value="'+i+'">'+i+'</option>';
    });
