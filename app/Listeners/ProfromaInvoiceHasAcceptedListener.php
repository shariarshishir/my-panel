...
use App\Mail\ProfromaInvoiceHasAcceptedMailToAdmin;
use App\Mail\ProfromaInvoiceHasAcceptedMailToBuyer;
use App\Http\Traits\PushNotificationTrait;

class ProfromaInvoiceHasAcceptedListener implements ShouldQueue
{
    ...
    public function handle($event)
    {
        ...
        Mail::to($event->proformaInvoice->buyer->email)->send(new ProfromaInvoiceHasAcceptedMailToBuyer($event->proformaInvoice, $event->rfqInfo));
        Mail::to('success@merchantbay.com')->send(new ProfromaInvoiceHasAcceptedMailToAdmin($event->proformaInvoice, $event->rfqInfo));
